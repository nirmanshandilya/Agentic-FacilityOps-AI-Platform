...
export NIX_BINTOOLS
NIX_LDFLAGS='-rpath /nix/store/694lx8vb54c85l6f71yjdic7zbl8x8d3-devenv-shell-env/lib '
export NIX_LDFLAGS
allowSubstitutes=''
...
export NIX_CC
nativeBuildInputs='/nix/store/gk8yl7vlvbch8sj8np06nrid98sj44rb-hello /nix/store/ci8zzrskpy76f5xzqshyxpyk1hnalbb5-bash-interactive-5.3p15-dev /nix/store/8wxs6573l730vxkqd6wp58kvxa19csll-git-2.55.0 /nix/store/0v0raqk1qw5g2a21km4xa1hwhaq4s976-pkg-config-wrapper-0.29.2'
...
DEVENV_PROFILE='/nix/store/syqarlkw0306fyvkygf43y6qq3z69l8f-devenv-profile'
...
AR='ar'
export AR
out='/nix/store/694lx8vb54c85l6f71yjdic7zbl8x8d3-devenv-shell-env'
export out
outputInfo='out'
...
defaultBuildInputs=''
prefix='/nix/store/694lx8vb54c85l6f71yjdic7zbl8x8d3-devenv-shell-env'
READELF='readelf'
export READELF
...
NIX_CFLAGS_COMPILE=' -frandom-seed=694lx8vb54 -isystem /nix/store/ci8zzrskpy76f5xzqshyxpyk1hnalbb5-bash-interactive-5.3p15-dev/include -isystem /nix/store/ci8zzrskpy76f5xzqshyxpyk1hnalbb5-bash-interactive-5.3p15-dev/include'
...
if [ ! -L "$DEVENV_DOTFILE/profile" ] || [ "$(/nix/store/97d5ygrvqj55f4nx1x34wfdcc7qn11c0-coreutils-9.11/bin/readlink $DEVENV_DOTFILE/profile)" != "/nix/store/syqarlkw0306fyvkygf43y6qq3z69l8f-devenv-profile" ]
then
  ln -snf /nix/store/syqarlkw0306fyvkygf43y6qq3z69l8f-devenv-profile "$DEVENV_DOTFILE/profile"
fi
...
exec /tmp/devenv-envNnMUYs/script 