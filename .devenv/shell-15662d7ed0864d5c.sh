...
NIX_CFLAGS_COMPILE=' -frandom-seed=08bqg4yihh -isystem /nix/store/ci8zzrskpy76f5xzqshyxpyk1hnalbb5-bash-interactive-5.3p15-dev/include -isystem /nix/store/hyw97nxddgxfc6ag6db87rnawss2pw1a-nodejs-22.23.2/include -isystem /nix/store/l9wkilihbd6xg5f7dmwzyxjlmaly45ib-jq-1.8.2-dev/include -isystem /nix/store/ci8zzrskpy76f5xzqshyxpyk1hnalbb5-bash-interactive-5.3p15-dev/include -isystem /nix/store/hyw97nxddgxfc6ag6db87rnawss2pw1a-nodejs-22.23.2/include -isystem /nix/store/l9wkilihbd6xg5f7dmwzyxjlmaly45ib-jq-1.8.2-dev/include'
export NIX_CFLAGS_COMPILE
NIX_LDFLAGS='-rpath /nix/store/08bqg4yihhgcfhrwcx6ixm11xf4xgirc-devenv-shell-env/lib  -L/nix/store/rj3zms0wpcp1q5vcbin93w3jyg2rdj84-jq-1.8.2/lib -L/nix/store/rj3zms0wpcp1q5vcbin93w3jyg2rdj84-jq-1.8.2/lib'
export NIX_LDFLAGS
PS4='+ '
outputDevman='out'
AR='ar'
...
out='/nix/store/08bqg4yihhgcfhrwcx6ixm11xf4xgirc-devenv-shell-env'
export out
doCheck=''
export doCheck
hardeningDisable=''
...
if [ ! -L "$DEVENV_DOTFILE/profile" ] || [ "$(/nix/store/97d5ygrvqj55f4nx1x34wfdcc7qn11c0-coreutils-9.11/bin/readlink $DEVENV_DOTFILE/profile)" != "/nix/store/5xy2xibq4zxgkvy8k5z2yvz1r9h27j1d-devenv-profile" ]
then
  ln -snf /nix/store/5xy2xibq4zxgkvy8k5z2yvz1r9h27j1d-devenv-profile "$DEVENV_DOTFILE/profile"
fi
...
depsHostHost=''
export depsHostHost
nativeBuildInputs='/nix/store/h97adbybcpsrlqybwz9mdn452q138qg5-hello /nix/store/ci8zzrskpy76f5xzqshyxpyk1hnalbb5-bash-interactive-5.3p15-dev /nix/store/32q9vbny83bwd30qx2hr3fi2grh5sn5w-mongodb-ce-8.2.12 /nix/store/p18jqr5bjsy81v1bi1p5incnpm62qwvm-mongo-tools-100.18.0 /nix/store/il3g929j4ib2zlb20jl8nq379ynrhhkv-mongosh-2.9.2 /nix/store/hyw97nxddgxfc6ag6db87rnawss2pw1a-nodejs-22.23.2 /nix/store/hyw97nxddgxfc6ag6db87rnawss2pw1a-nodejs-22.23.2 /nix/store/ich604d7gnsl3blwzjvga2jn2i3rgl3a-typescript-language-server-5.3.0 /nix/store/8wxs6573l730vxkqd6wp58kvxa19csll-git-2.55.0 /nix/store/l9wkilihbd6xg5f7dmwzyxjlmaly45ib-jq-1.8.2-dev /nix/store/xvhidk4sh8njx20brz7s4sx3s356i55y-nodemon-3.1.14 /nix/store/0v0raqk1qw5g2a21km4xa1hwhaq4s976-pkg-config-wrapper-0.29.2'
...
prefix='/nix/store/08bqg4yihhgcfhrwcx6ixm11xf4xgirc-devenv-shell-env'
...
PKG_CONFIG_PATH='/nix/store/ci8zzrskpy76f5xzqshyxpyk1hnalbb5-bash-interactive-5.3p15-dev/lib/pkgconfig:/nix/store/l9wkilihbd6xg5f7dmwzyxjlmaly45ib-jq-1.8.2-dev/lib/pkgconfig'
...
exec /tmp/devenv-envWvAJ1A/script 